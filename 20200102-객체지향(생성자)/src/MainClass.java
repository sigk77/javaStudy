...
//		age=25;
	...
	public MainClass(String name, String sex, int age)
	{
		...
		this.sex=sex;
		this.age=age;
		// 자신의 개체주소 => this => 반드시 메소드 안에서만 사용이 가능
	}
	public static void main(String[] args) {
		...
		MainClass mc3=new MainClass("강감찬","남자",30);
		...
		/*
		 * // static이 아닌 변수는 저장공간을 별도로 만들어서 저장해야한다 (new) // 생성자는 호출시에 반드시 new를 동반한다 //
		 * new MainClass(); System.out.println(mc.name); System.out.println(mc.sex);
